...
def create_cover_image(
    ...
    try:
        ...
        alpha_left = alpha_left.point(lambda i: i * 0.25) # Adjust opacity (0.25 means 25% opacity)
...
image_path = Path("5") / "cover.png"
output_path = Path("5") / "cover-with-text.jpg"

create_cover_image(
    image_path=image_path,
    output_path=output_path,
    text="Tuning Your Inner Frequency to Attract Genuine Connection"
) 